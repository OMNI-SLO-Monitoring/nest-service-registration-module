...
let ServiceRegistration = class ServiceRegistration {
    constructor() {
        this.SERVICE_REGISTRATION_DIR = "service-registration.json";
    }
    readRegistration() {
...
ServiceRegistration = __decorate([
    common_1.Injectable()
], ServiceRegistration);
exports.ServiceRegistration = ServiceRegistration;
//# sourceMappingURL=service-registration.service.js.map